...
-- Tiempo de generación: 28-06-2025 a las 23:42:11
...
SELECT 
    p.producto AS nombre_producto, -- Nombre del producto
    SUM(df.cantidad) AS total_vendidos -- Total de productos vendidos
FROM 
    detalle_factura df
INNER JOIN 
    producto p ON df.codproducto = p.codproducto -- Relación entre ambas tablas
WHERE 
    df.estatus_dt = 1 AND p.categoria NOT IN (20, 21, 22, 24, 25, 26, 27)-- Filtrar solo productos activos en detalle_factura
GROUP BY 
    df.codproducto, p.producto -- Agrupar por código y nombre del producto
ORDER BY 
    total_vendidos DESC -- Ordenar por la cantidad total vendida
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `procesar_venta` (IN `cod_usuario` BIGINT, IN `cod_cliente` BIGINT, IN `token` VARCHAR(100), IN `mesa_id` INT, IN `pago` INT, IN `codigopago` VARCHAR(20), IN `id_cupon` INT, IN `caja` INT)   BEGIN
    ...
    DECLARE codigo_cupon VARCHAR(20) DEFAULT '';
    ...
    FROM detalle_temp
    WHERE token_user = token AND mesa = mesa_id;

    IF registros > 0 THEN

        INSERT INTO tbl_tmp_tokenuser(cod_prod, cant_prod, observaciones)
        SELECT codproducto, cantidad, observaciones
        FROM detalle_temp
        WHERE token_user = token AND mesa = mesa_id;

        -- Obtener el código del cupón si existe
        IF id_cupon <> 0 THEN
            SELECT codigo INTO codigo_cupon
        ...
        -- Bucle optimizado para actualizar existencias
        WHILE a <= registros DO
            ...
            FROM producto
            WHERE codproducto = tmp_cod_producto;
        ...
        IF id_cupon <> 0 THEN
            SELECT tipo INTO tipo_cupon
            FROM codigos_promocionales
            WHERE id = id_cupon
            LIMIT 1;

            IF tipo_cupon = 1 THEN
                SELECT dinero INTO dinero_1
                FROM codigos_promocionales
                WHERE id = id_cupon
                LIMIT 1;
                SET total = subtotal - dinero_1;
            ELSEIF tipo_cupon = 2 THEN
                SELECT porcentaje INTO porcentaje_1
                FROM codigos_promocionales
                WHERE id = id_cupon
                LIMIT 1;
...
CREATE TABLE IF NOT EXISTS `arqueo_caja` (
  ...
  `deuna` decimal(10,0) DEFAULT NULL,
  `tarjeta` decimal(10,2) DEFAULT NULL,
  `salida` decimal(10,0) NOT NULL,
  `salarios` decimal(10,0) NOT NULL,
...
INSERT INTO `arqueo_caja` (`id`, `id_caja`, `id_usuario`, `fecha_inicio`, `fecha_fin`, `monto_inicial`, `monto_final`, `total_ventas`, `total_cash`, `efectivo`, `transferencia`, `deuna`, `tarjeta`, `salida`, `salarios`, `estatus`) VALUES
(19, 1, '1803641420', '2023-11-03 20:47:42', '2023-11-04 19:57:17', 10.00, 138.00, 11, 128.31, NULL, NULL, 0, NULL, 0, 0, 2),
(20, 1, '1850108166', '2023-11-04 20:03:58', '2023-11-04 20:07:08', 15.00, 20.00, 1, 9.97, NULL, NULL, 0, NULL, 0, 0, 2),
(21, 1, '302433214', '2023-11-04 20:07:25', '2023-11-04 20:09:54', 20.00, 30.00, 1, 9.99, NULL, NULL, 0, NULL, 0, 0, 2),
(22, 1, '1850108166', '2023-11-04 20:10:09', '2023-11-04 20:35:54', 30.00, 200.00, 3, 225.51, NULL, NULL, 0, NULL, 0, 0, 2),
(23, 1, '1234', '2023-11-04 20:38:41', '2023-11-04 20:44:05', 50.00, 10.00, 1, 6.49, NULL, NULL, 0, NULL, 0, 0, 2),
(24, 1, '302433214', '2023-11-04 20:44:36', '2023-11-17 20:08:53', 10.00, 11.00, 1, 1.25, NULL, NULL, 0, NULL, 0, 0, 2),
(25, 2, '1234', '2023-11-12 00:48:23', '2023-11-17 20:18:45', 10.00, 42.00, 3, 32.44, NULL, NULL, 0, NULL, 0, 0, 2),
(26, 3, '1850108166', '2023-11-17 20:08:13', '2023-11-17 20:18:12', 15.00, 23.00, 1, 7.97, NULL, NULL, 0, NULL, 0, 0, 2),
(27, 1, '1850108166', '2023-11-17 20:19:33', '2023-12-03 12:36:10', 15.00, 50.00, 2, 35.96, NULL, NULL, 0, NULL, 0, 0, 2),
(28, 1, '302433214', '2023-12-03 12:36:28', '2023-12-03 12:38:43', 10.00, 10.00, 1, 27.94, NULL, NULL, 0, NULL, 0, 0, 2),
(29, 1, '302433214', '2023-12-03 12:40:13', '2023-12-03 12:41:31', 15.00, 19.00, 1, 3.99, NULL, NULL, 0, NULL, 0, 0, 2),
(30, 1, '1850108166', '2023-12-03 13:27:57', '2024-02-03 11:42:25', 10.00, 23.00, 1, 13.97, NULL, NULL, 0, NULL, 0, 0, 2),
(31, 3, '302433214', '2023-12-08 21:00:44', '2024-02-03 11:42:07', 67.00, 10.00, 1, 6.49, NULL, NULL, 0, NULL, 0, 0, 2),
(32, 1, '1234', '2024-02-03 11:42:45', '2024-02-03 18:41:42', 1.00, 16.00, 2, 15.96, NULL, NULL, 0, NULL, 0, 0, 2),
(33, 1, '302433214', '2024-02-03 18:44:16', '2024-02-04 12:10:41', 18.00, 228.00, 8, 210.42, NULL, NULL, 0, NULL, 0, 0, 2),
(34, 1, '1234', '2024-02-04 12:11:43', '2024-02-04 12:23:42', 1.00, 22.00, 1, 21.99, NULL, NULL, 0, NULL, 0, 0, 2),
(35, 1, '1234', '2024-02-06 21:49:03', '2024-02-07 22:47:45', 10.00, 10.00, 1, 6.97, 0.00, 10.00, 0, 0.00, 0, 0, 2),
(36, 1, '302433214', '2024-02-07 22:48:12', '2024-02-07 22:55:07', 10.00, 23.47, 1, 13.47, 23.47, 0.00, 0, 0.00, 0, 0, 2),
(37, 1, '302433214', '2024-02-07 22:56:18', '2024-02-07 23:00:34', 10.00, 26.46, 1, 16.46, 26.46, 0.00, 0, 0.00, 0, 0, 2),
(38, 1, '302433214', '2024-02-07 23:03:13', '2024-02-07 23:04:33', 10.00, 34.00, 0, 0.00, 34.00, 0.00, 0, 0.00, 0, 0, 2),
(39, 1, '302433214', '2024-02-07 23:07:47', '2024-02-07 23:19:36', 20.00, 33.39, 1, 13.98, 20.00, 13.39, 0, 0.00, 0, 0, 2),
(40, 1, '302433214', '2024-02-07 23:20:51', '2024-02-08 20:29:50', 25.00, 300.00, 3, 59.14, 300.00, 0.00, 0, 0.00, 0, 0, 2),
(41, 1, '302433214', '2024-02-08 20:30:10', '2024-02-08 20:34:40', 27.40, 50.37, 1, 22.97, 50.37, 0.00, 0, 0.00, 0, 0, 2),
(42, 1, '1850108166', '2024-02-08 20:35:53', '2024-02-08 20:39:31', 27.40, 64.86, 1, 37.46, 64.86, 0.00, 0, 0.00, 0, 0, 2),
(43, 2, '302433214', '2024-02-08 20:40:40', '2024-02-08 20:42:19', 12.00, 12.00, 0, 0.00, 12.00, 0.00, 0, 0.00, 0, 0, 2),
(44, 1, '302433214', '2024-02-08 20:49:15', '2024-02-08 20:53:56', 27.40, 65.60, 2, 38.20, 65.60, 0.00, 0, 0.00, 0, 0, 2),
(45, 1, '302433214', '2024-02-09 18:11:45', '2024-02-10 00:02:08', 27.15, 62.84, 6, 35.69, 62.84, 0.00, 0, 0.00, 0, 0, 2),
(46, 1, '302433214', '2024-02-10 08:58:02', '2024-02-10 08:58:23', 28.80, 28.80, 0, 0.00, 28.80, 0.00, 0, 0.00, 0, 0, 2),
(47, 1, '302433214', '2024-02-10 08:58:49', '2024-02-10 11:02:35', 28.80, 28.80, 0, 0.00, 28.80, 0.00, 0, 0.00, 0, 0, 2),
(48, 1, '302433214', '2024-02-10 17:58:39', '2024-02-10 18:34:00', 10.00, 32.96, 1, 22.96, 32.96, 0.00, 0, 0.00, 0, 0, 2),
(49, 1, '302433214', '2024-02-10 19:01:46', '2024-02-10 19:01:58', 1.00, 1.00, 0, 0.00, 1.00, 0.00, 0, 0.00, 0, 0, 2),
(50, 1, '302433214', '2024-02-10 19:04:06', '2024-02-10 19:04:18', 10.00, 10.00, 0, 0.00, 10.00, 0.00, 0, 0.00, 0, 0, 2),
(51, 1, '302433214', '2024-02-10 19:25:54', '2024-02-10 19:26:02', 10.00, 10.00, 0, 0.00, 10.00, 0.00, 0, 0.00, 0, 0, 2),
(52, 1, '302433214', '2024-02-10 19:26:45', '2024-02-10 19:26:55', 10.00, 10.00, 0, 0.00, 5.00, 2.00, 0, 3.00, 0, 0, 2),
(53, 1, '302433214', '2024-02-10 19:32:44', '2024-02-10 19:32:54', 10.00, 4.00, 0, 0.00, 1.00, 1.00, 0, 2.00, 0, 0, 2),
(54, 1, '302433214', '2024-02-10 19:37:11', '2024-02-10 19:37:18', 10.00, 1.00, 0, 0.00, 0.00, 0.00, 0, 1.00, 0, 0, 2),
(55, 1, '302433214', '2024-02-10 19:37:57', '2024-02-10 19:38:05', 1.00, 11.00, 0, 0.00, 11.00, 0.00, 0, 0.00, 0, 0, 2),
(56, 1, '302433214', '2024-02-10 19:40:50', '2024-02-10 19:40:58', 2.00, 22.00, 0, 0.00, 0.00, 22.00, 0, 0.00, 0, 0, 2),
(57, 1, '302433214', '2024-02-10 19:42:32', '2024-02-10 19:42:39', 10.00, 33.00, 0, 0.00, 0.00, 0.00, 0, 33.00, 0, 0, 2),
(58, 1, '302433214', '2024-02-10 19:44:42', '2024-02-10 19:44:49', 10.00, 22.00, 0, 0.00, 0.00, 22.00, 0, 0.00, 0, 0, 2),
(59, 1, '302433214', '2024-02-10 19:49:22', '2024-02-10 19:49:32', 1.00, 333.00, 0, 0.00, 333.00, 0.00, 0, 0.00, 0, 0, 2),
(60, 1, '302433214', '2024-02-10 19:51:19', '2024-02-11 00:17:42', 26.80, 400.00, 26, 371.26, 400.00, 0.00, 0, 0.00, 0, 0, 2),
(61, 1, '302433214', '2024-02-11 00:19:00', '2024-02-11 01:09:52', 1.00, 16.47, 4, 15.47, 16.47, 0.00, 0, 0.00, 0, 0, 2),
(62, 1, '302433214', '2024-02-11 10:09:21', '2024-02-11 10:31:08', 1.00, 105.00, 9, 103.81, 105.00, 0.00, 0, 0.00, 0, 0, 2),
(63, 1, '302433214', '2024-02-11 10:33:11', '2024-02-11 10:33:20', 10.00, 10.00, 0, 0.00, 0.00, 0.00, 0, 10.00, 0, 0, 2),
(64, 1, '302433214', '2024-02-11 10:35:27', '2024-02-11 18:01:51', 1.00, 117.82, 7, 116.82, 117.82, 0.00, 0, 0.00, 0, 0, 2),
(65, 1, '302433214', '2024-02-11 18:07:55', '2024-02-11 18:42:27', 5.85, 5.85, 0, 0.00, 5.85, 0.00, 0, 0.00, 0, 0, 2),
(66, 1, '302433214', '2024-02-11 18:42:42', '2024-02-12 01:16:19', 25.85, 493.02, 64, 647.77, 493.02, 0.00, 0, 0.00, 0, 0, 2),
(67, 1, '302433214', '2024-02-12 16:30:06', '2024-02-12 16:38:00', 2.29, 91.36, 1, 91.36, 91.36, 0.00, 0, 0.00, 0, 0, 2),
(68, 1, '302433214', '2024-02-12 16:38:21', '2024-02-12 17:57:45', 1.00, 24.22, 2, 23.22, 24.22, 0.00, 0, 0.00, 0, 0, 2),
(69, 1, '302433214', '2024-02-12 18:00:10', '2024-02-13 00:47:45', 8.25, 234.13, 30, 265.83, 234.13, 0.00, 0, 0.00, 0, 0, 2),
(70, 1, '302433214', '2024-02-13 00:55:33', '2024-02-13 01:12:28', 30.00, 31.98, 1, 1.98, 31.98, 0.00, 0, 0.00, 0, 0, 2),
(71, 1, '302433214', '2024-02-13 18:17:37', '2024-02-13 23:04:36', 24.00, 105.82, 10, 81.82, 105.82, 0.00, 0, 0.00, 0, 0, 2),
(72, 1, '302433214', '2024-02-15 18:09:14', '2024-02-15 18:12:17', 12.00, 29.96, 2, 17.96, 29.96, 0.00, 0, 0.00, 0, 0, 2),
(73, 1, '302433214', '2024-02-15 18:21:49', '2024-02-15 23:57:20', 13.60, 42.04, 4, 28.44, 42.04, 0.00, 0, 0.00, 0, 0, 2),
(74, 1, '302433214', '2024-02-16 08:10:28', '2024-02-16 23:57:23', 12.60, 55.21, 10, 42.61, 55.21, 0.00, 0, 0.00, 0, 0, 2),
(75, 1, '302433214', '2024-02-17 18:06:36', '2024-02-18 00:19:32', 19.75, 153.73, 18, 133.98, 153.73, 0.00, 0, 0.00, 0, 0, 2),
(76, 1, '302433214', '2024-02-18 08:01:49', '2024-02-18 23:53:06', 7.00, 60.66, 4, 53.66, 60.66, 0.00, 0, 0.00, 0, 0, 2),
(77, 2, '302433214', '2024-02-18 19:47:20', '2024-02-18 19:47:47', 7.00, 7.00, 0, 0.00, 7.00, 0.00, 0, 0.00, 0, 0, 2),
(78, 1, '1850108166', '2024-02-21 18:12:44', '2024-02-21 23:39:47', 14.30, 46.23, 3, 31.93, 46.23, 0.00, 0, 0.00, 0, 0, 2),
(79, 1, '1850108166', '2024-02-22 18:04:04', '2024-02-22 23:42:06', 18.80, 39.78, 3, 20.98, 39.78, 0.00, 0, 0.00, 0, 0, 2),
(80, 1, '302433214', '2024-02-23 19:54:39', '2024-02-23 23:50:27', 34.70, 52.70, 1, 17.99, 52.70, 0.00, 0, 0.00, 0, 0, 2),
(81, 1, '302433214', '2024-02-24 18:17:36', '2024-02-24 20:26:26', 48.70, 61.48, 1, 12.48, 61.48, 0.00, 0, 0.00, 0, 0, 2),
(82, 1, '302433214', '2024-02-24 20:26:55', '2024-02-24 23:50:50', 48.70, 94.13, 4, 45.43, 94.13, 0.00, 0, 0.00, 0, 0, 2),
(83, 1, '302433214', '2024-02-25 18:07:14', '2024-02-25 18:58:56', 18.80, 18.80, 0, 0.00, 18.80, 0.00, 0, 0.00, 0, 0, 2),
(84, 1, '302433214', '2024-02-25 18:59:40', '2024-02-25 23:40:43', 13.80, 94.36, 7, 80.56, 94.36, 0.00, 0, 0.00, 0, 0, 2),
(85, 1, '1850108166', '2024-02-28 18:02:38', '2024-02-29 08:27:12', 9.10, 63.74, 5, 54.64, 63.74, 0.00, 0, 0.00, 0, 0, 2),
(86, 1, '302433214', '2024-02-29 18:12:03', '2024-03-01 18:07:13', 12.15, 22.88, 3, 10.73, 22.88, 0.00, 0, 0.00, 0, 0, 2),
(87, 1, '302433214', '2024-03-01 18:07:35', '2024-03-01 23:54:37', 21.90, 86.05, 5, 64.15, 86.05, 0.00, 0, 0.00, 0, 0, 2),
(88, 1, '302433214', '2024-03-02 20:58:06', '2024-03-03 00:01:28', 5.45, 55.62, 7, 39.69, 45.14, 10.48, 0, 0.00, 0, 0, 2),
(89, 1, '302433214', '2024-03-03 19:20:51', '2024-03-04 00:00:48', 4.90, 62.82, 4, 57.92, 62.82, 0.00, 0, 0.00, 0, 0, 2),
(90, 1, '302433214', '2024-03-06 18:53:58', '2024-03-07 19:18:09', 16.85, 106.37, 18, 89.52, 106.37, 0.00, 0, 0.00, 0, 0, 2),
(91, 1, '302433214', '2024-03-07 19:21:12', '2024-03-07 19:31:03', 10.35, 10.35, 0, 0.00, 10.35, 0.00, 0, 0.00, 0, 0, 2),
(92, 1, '302433214', '2024-03-07 19:32:14', '2024-03-07 19:35:14', 16.30, 16.30, 0, 0.00, 16.30, 0.00, 0, 0.00, 0, 0, 2),
(93, 1, '302433214', '2024-03-07 19:35:33', '2024-03-07 19:36:13', 16.30, 16.30, 0, 0.00, 16.30, 0.00, 0, 0.00, 0, 0, 2),
(94, 1, '302433214', '2024-03-07 19:36:35', '2024-03-07 23:54:05', 16.30, 27.75, 5, 11.45, 27.75, 0.00, 0, 0.00, 0, 0, 2),
(95, 1, '302433214', '2024-03-08 07:58:37', '2024-03-08 08:05:53', 14.75, 14.75, 0, 0.00, 14.75, 0.00, 0, 0.00, 0, 0, 2),
(96, 1, '302433214', '2024-03-08 18:12:03', '2024-03-08 23:56:04', 58.45, 163.03, 14, 104.58, 163.03, 0.00, 0, 0.00, 0, 0, 2),
(97, 1, '302433214', '2024-03-09 18:21:11', '2024-03-10 00:00:09', 13.40, 122.72, 13, 109.32, 122.72, 0.00, 0, 0.00, 0, 0, 2),
(98, 1, '302433214', '2024-03-10 18:16:59', '2024-03-10 23:03:58', 10.15, 35.61, 3, 25.46, 35.61, 0.00, 0, 0.00, 0, 0, 2),
(99, 1, '302433214', '2024-03-13 19:57:37', '2024-03-13 23:27:46', 15.10, 60.99, 4, 45.89, 60.99, 0.00, 0, 0.00, 0, 0, 2),
(100, 1, '302433214', '2024-03-14 18:25:47', '2024-03-14 23:55:24', 17.60, 74.96, 4, 57.36, 74.96, 0.00, 0, 0.00, 0, 0, 2),
(101, 1, '302433214', '2024-03-15 20:06:28', '2024-03-16 00:01:18', 76.80, 184.15, 12, 85.34, 158.20, 0.00, 0, 25.95, 0, 0, 2),
(102, 1, '302433214', '2024-03-16 00:06:28', '2024-03-17 19:28:59', 1.00, 50.00, 4, 40.45, 50.00, 0.00, 0, 0.00, 0, 0, 2),
(103, 1, '302433214', '2024-03-17 19:34:13', '2024-03-17 23:24:56', 3.55, 144.09, 12, 140.54, 144.09, 0.00, 0, 0.00, 0, 0, 2),
(104, 1, '1234', '2024-03-18 13:12:48', '2024-03-20 09:20:01', 10.00, 9284.00, 12, 82.84, 9284.00, 0.00, 0, 0.00, 0, 0, 2),
(105, 1, '1850108166', '2024-03-20 09:22:31', '2024-03-21 00:03:09', 2.00, 58.47, 5, 58.47, 12.70, 45.77, 0, 0.00, 0, 0, 2),
(106, 1, '1850108166', '2024-03-21 08:04:43', '2024-03-21 18:12:21', 14.45, 28.43, 1, 13.98, 28.43, 0.00, 0, 0.00, 0, 0, 2),
(107, 2, '1850108166', '2024-03-21 18:12:52', '2024-03-21 18:13:12', 27.45, 27.45, 0, 0.00, 27.45, 0.00, 0, 0.00, 0, 0, 2),
(108, 1, '1850108166', '2024-03-21 18:13:35', '2024-03-22 18:38:05', 27.45, 153.43, 10, 125.98, 153.43, 0.00, 0, 0.00, 0, 0, 2),
(109, 1, '1850108166', '2024-03-22 18:39:40', '2024-03-22 23:20:36', 13.50, 13.50, 0, 0.00, 13.50, 0.00, 0, 0.00, 0, 0, 2),
(110, 1, '302433214', '2024-03-22 23:23:21', '2024-03-22 23:23:34', 10.00, 10.00, 0, 0.00, 10.00, 0.00, 0, 0.00, 0, 0, 2),
(111, 1, '302433214', '2024-03-22 23:31:59', '2024-03-23 09:42:09', 10.00, 1.00, 0, 0.00, 1.00, 0.00, 0, 0.00, 0, 0, 2),
(112, 1, '1234', '2024-03-23 09:42:19', '2024-03-23 09:46:48', 10.00, 10.00, 1, 3.99, 10.00, 0.00, 0, 0.00, 0, 0, 2),
(113, 1, '302433214', '2024-03-23 09:49:18', '2024-03-23 12:04:32', 4.00, 38.15, 4, 34.15, 38.15, 0.00, 0, 0.00, 0, 0, 2),
(114, 1, '302433214', '2024-03-23 15:55:34', '2024-03-23 18:03:35', 4.75, 19.98, 2, 15.23, 19.98, 0.00, 0, 0.00, 0, 0, 2),
(115, 1, '302433214', '2024-03-23 18:10:09', '2024-03-23 23:52:16', 22.95, 159.09, 31, 239.76, 159.09, 0.00, 0, 0.00, 0, 0, 2),
(116, 1, '302433214', '2024-03-24 00:13:42', '2024-03-24 00:35:10', 1.00, 10.00, 1, 8.99, 10.00, 0.00, 0, 0.00, 0, 0, 2),
(117, 1, '302433214', '2024-03-24 08:06:21', '2024-03-24 18:14:37', 20.70, 47.14, 3, 26.45, 47.14, 0.00, 0, 0.00, 0, 0, 2),
(118, 1, '302433214', '2024-03-24 18:14:49', '2024-03-24 23:01:40', 32.70, 90.20, 5, 64.90, 90.20, 0.00, 0, 0.00, 0, 0, 2),
(119, 1, '1850108166', '2024-03-27 18:38:09', '2024-03-27 23:26:40', 9.45, 81.57, 8, 81.57, 56.38, 25.19, 0, 0.00, 0, 0, 2),
(120, 1, '1850108166', '2024-03-28 07:59:30', '2024-03-28 23:02:23', 16.20, 14.49, 2, 14.49, 14.49, 0.00, 0, 0.00, 0, 0, 2),
(121, 1, '1850108166', '2024-03-29 09:30:34', '2024-03-29 18:30:54', 23.00, 44.49, 1, 21.49, 44.49, 0.00, 0, 0.00, 0, 0, 2),
(122, 1, '302433214', '2024-03-29 18:35:49', '2024-03-30 00:01:19', 14.00, 174.00, 16, 174.02, 160.00, 14.00, 0, 0.00, 0, 0, 2),
(123, 1, '302433214', '2024-03-30 07:15:10', '2024-03-30 23:43:22', 7.00, 199.36, 21, 192.36, 142.42, 56.94, 0, 0.00, 0, 0, 2),
(124, 1, '302433214', '2024-03-31 01:09:38', '2024-03-31 07:02:29', 2.00, 11.75, 1, 9.75, 11.75, 0.00, 0, 0.00, 0, 0, 2),
(125, 2, '302433214', '2024-03-31 07:01:30', '2024-03-31 07:02:03', 4.45, 4.45, 0, 0.00, 4.45, 0.00, 0, 0.00, 0, 0, 2),
(126, 1, '302433214', '2024-03-31 07:02:48', '2024-03-31 17:58:08', 4.45, 57.38, 8, 52.93, 57.38, 0.00, 0, 0.00, 0, 0, 2),
(127, 1, '302433214', '2024-03-31 17:58:39', '2024-03-31 22:19:45', 5.75, 26.22, 3, 20.47, 26.22, 0.00, 0, 0.00, 0, 0, 2),
(128, 1, '1850108166', '2024-04-03 08:09:24', '2024-04-03 23:34:05', 5.00, 50.88, 4, 50.88, 50.88, 0.00, 0, 0.00, 0, 0, 2),
(129, 1, '1850108166', '2024-04-04 08:09:24', '2024-04-04 23:54:31', 19.00, 73.19, 5, 54.18, 59.19, 14.00, 0, 0.00, 0, 0, 2),
(130, 1, '302433214', '2024-04-05 08:02:25', '2024-04-05 23:58:28', 11.25, 55.94, 5, 44.69, 55.94, 0.00, 0, 0.00, 0, 0, 2),
(131, 1, '302433214', '2024-04-06 07:05:13', '2024-04-06 11:25:54', 9.95, 109.33, 11, 99.38, 109.33, 0.00, 0, 0.00, 0, 0, 2),
(132, 1, '302433214', '2024-04-06 18:03:35', '2024-04-06 23:19:34', 8.50, 195.20, 16, 186.70, 195.20, 0.00, 0, 0.00, 0, 0, 2),
(133, 1, '302433214', '2024-04-07 06:55:49', '2024-04-07 23:06:12', 16.20, 84.63, 8, 68.43, 84.63, 0.00, 0, 0.00, 0, 0, 2),
(134, 1, '1850108166', '2024-04-10 17:47:42', '2024-04-10 23:35:51', 16.40, 61.17, 7, 61.17, 61.17, 0.00, 0, 0.00, 0, 0, 2),
(135, 1, '302433214', '2024-04-11 19:06:01', '2024-04-11 23:59:39', 20.00, 37.48, 2, 17.48, 37.48, 0.00, 0, 0.00, 0, 0, 2),
(136, 1, '302433214', '2024-04-12 08:00:54', '2024-04-12 23:56:53', 9.60, 134.89, 17, 134.89, 128.89, 6.00, 0, 0.00, 0, 0, 2),
(137, 1, '302433214', '2024-04-13 06:59:26', '2024-04-14 00:05:27', 20.00, 224.47, 20, 260.38, 224.47, 0.00, 0, 0.00, 0, 0, 2),
(138, 1, '302433214', '2024-04-14 01:05:17', '2024-04-14 07:09:25', 1.00, 20.95, 1, 19.95, 1.00, 19.95, 0, 0.00, 0, 0, 2),
(139, 1, '1850108166', '2024-04-14 08:17:08', '2024-04-17 18:07:45', 1.00, 98.19, 7, 98.19, 98.19, 0.00, 0, 0.00, 0, 0, 2),
(140, 1, '1850108166', '2024-04-17 18:14:15', '2024-04-19 10:13:53', 22.00, 22.00, 0, 0.00, 22.00, 0.00, 0, 0.00, 0, 0, 2),
(141, 1, '1850108166', '2024-04-24 08:07:18', '2024-04-24 08:38:26', 4.60, 4.60, 0, 0.00, 4.60, 0.00, 0, 0.00, 0, 0, 2),
(142, 1, '1850108166', '2024-04-24 08:40:10', '2024-04-24 23:46:49', 13.10, 84.36, 4, 84.36, 84.36, 0.00, 0, 0.00, 0, 0, 2),
(143, 1, '1850108166', '2024-04-25 09:50:47', '2024-04-25 23:52:52', 8.00, 65.88, 6, 65.88, 65.88, 0.00, 0, 0.00, 0, 0, 2),
(144, 1, '1850108166', '2024-04-26 08:48:43', '2024-04-27 00:01:19', 17.00, 73.00, 7, 73.98, 73.00, 0.00, 0, 0.00, 0, 0, 2),
(145, 1, '1850108166', '2024-04-27 08:44:36', '2024-04-27 18:33:25', 17.10, 70.42, 5, 70.42, 57.95, 12.47, 0, 0.00, 0, 0, 2),
(146, 1, '1850108166', '2024-04-27 18:37:53', '2024-04-27 23:59:03', 24.05, 40.53, 3, 16.48, 40.53, 0.00, 0, 0.00, 0, 0, 2),
(147, 1, '302433214', '2024-04-28 07:10:48', '2024-04-28 23:25:30', 20.60, 228.02, 24, 228.02, 215.54, 12.48, 0, 0.00, 0, 0, 2),
(148, 1, '1850108166', '2024-05-01 08:10:57', '2024-05-01 23:43:22', 4.00, 38.95, 3, 38.95, 19.97, 18.98, 0, 0.00, 0, 0, 2),
(149, 1, '302433214', '2024-05-02 19:46:57', '2024-05-04 00:02:10', 13.00, 31.18, 9, 31.18, 31.18, 0.00, 0, 0.00, 0, 0, 2),
(150, 1, '302433214', '2024-05-04 07:12:52', '2024-05-04 19:23:55', 3.75, 0.99, 1, 0.99, 0.99, 0.00, 0, 0.00, 0, 0, 2),
(151, 1, '302433214', '2024-05-04 19:24:18', '2024-05-04 23:56:23', 14.25, 44.14, 11, 68.10, 44.14, 0.00, 0, 0.00, 0, 0, 2),
(152, 1, '302433214', '2024-05-05 08:10:54', '2024-05-05 11:47:50', 17.00, 112.18, 12, 122.67, 112.18, 0.00, 0, 0.00, 0, 0, 2),
(153, 1, '302433214', '2024-05-05 20:27:55', '2024-05-05 23:11:55', 0.50, 23.92, 3, 23.92, 23.92, 0.00, 0, 0.00, 0, 0, 2),
(154, 1, '1850108166', '2024-05-08 08:04:11', '2024-05-09 18:17:07', 9.65, 5.50, 2, 27.50, 5.50, 0.00, 0, 0.00, 0, 0, 2),
(155, 1, '1850108166', '2024-05-09 18:18:35', '2024-05-09 20:29:52', 16.15, 16.15, 0, 0.00, 16.15, 0.00, 0, 0.00, 0, 0, 2),
(156, 1, '1850108166', '2024-05-09 20:30:18', '2024-05-10 20:09:28', 31.15, 31.15, 0, 0.00, 31.15, 0.00, 0, 0.00, 0, 0, 2),
(157, 1, '302433214', '2024-05-10 20:09:55', '2024-05-12 09:03:57', 31.15, 97.35, 7, 97.35, 97.35, 0.00, 0, 0.00, 0, 0, 2),
(158, 1, '302433214', '2024-05-12 09:09:30', '2024-05-12 22:44:55', 17.65, 20.95, 3, 20.95, 20.95, 0.00, 0, 0.00, 0, 0, 2),
(159, 1, '1850108166', '2024-05-15 10:10:49', '2024-05-16 00:01:15', 3.00, 54.70, 4, 54.70, 54.70, 0.00, 0, 0.00, 0, 0, 2),
(160, 1, '1850108166', '2024-05-16 08:40:13', '2024-05-17 21:07:03', 15.00, 7.00, 1, 7.00, 7.00, 0.00, 0, 0.00, 0, 0, 2),
(161, 1, '302433214', '2024-05-17 21:08:18', '2024-05-18 23:56:42', 10.55, 129.77, 9, 129.77, 129.77, 0.00, 0, 0.00, 0, 0, 2),
(162, 1, '302433214', '2024-05-18 23:58:51', '2024-05-19 23:30:21', 10.00, 83.63, 7, 83.63, 83.63, 0.00, 0, 0.00, 0, 0, 2),
(163, 1, '302433214', '2024-05-23 18:20:13', '2024-05-24 00:00:56', 10.70, 25.96, 3, 42.95, 25.96, 0.00, 0, 0.00, 0, 0, 2),
(164, 1, '302433214', '2024-05-24 08:05:26', '2024-05-25 00:02:20', 3.70, 72.36, 8, 72.36, 72.36, 0.00, 0, 0.00, 0, 0, 2),
(165, 1, '302433214', '2024-05-25 07:05:51', '2024-05-26 00:07:08', 8.25, 150.75, 17, 155.74, 150.75, 0.00, 0, 0.00, 0, 0, 2),
(166, 1, '302433214', '2024-05-26 07:09:11', '2024-05-27 00:02:18', 17.95, 86.51, 12, 86.51, 86.51, 0.00, 0, 0.00, 0, 0, 2),
(167, 1, '1850108166', '2024-05-29 09:30:11', '2024-05-29 23:55:01', 9.80, 5.50, 1, 5.50, 5.50, 0.00, 0, 0.00, 0, 0, 2),
(168, 1, '1850108166', '2024-05-30 07:59:48', '2024-05-30 18:14:19', 14.30, 22.00, 2, 22.00, 22.00, 0.00, 0, 0.00, 0, 0, 2),
(169, 1, '1850108166', '2024-05-30 18:17:11', '2024-05-31 08:05:00', 20.05, 16.96, 1, 16.96, 16.96, 0.00, 0, 0.00, 0, 0, 2),
(170, 1, '302433214', '2024-05-31 08:05:43', '2024-05-31 23:54:24', 37.00, 61.44, 7, 61.44, 61.44, 0.00, 0, 0.00, 0, 0, 2),
(171, 1, '302433214', '2024-06-01 22:15:15', '2024-06-02 23:53:09', 10.74, 43.91, 9, 46.90, 43.91, 0.00, 0, 0.00, 0, 0, 2),
(172, 1, '1850108166', '2024-06-05 08:17:04', '2024-06-07 08:07:04', 1.50, 66.58, 10, 66.58, 66.58, 0.00, 0, 0.00, 0, 0, 2),
(173, 1, '302433214', '2024-06-07 08:14:13', '2024-06-08 00:14:55', 5.00, 32.68, 6, 59.39, 32.68, 0.00, 0, 0.00, 0, 0, 2),
(174, 1, '302433214', '2024-06-08 07:44:31', '2024-06-08 23:55:21', 2.00, 102.74, 8, 118.71, 102.74, 0.00, 0, 0.00, 0, 0, 2),
(175, 1, '302433214', '2024-06-09 09:52:04', '2024-06-09 23:27:08', 4.85, 130.81, 15, 159.23, 130.81, 0.00, 0, 0.00, 0, 0, 2),
(176, 1, '1850108166', '2024-06-12 20:43:37', '2024-06-13 08:07:52', 1.00, 21.94, 2, 21.94, 21.94, 0.00, 0, 0.00, 0, 0, 2),
(177, 1, '1850108166', '2024-06-13 08:12:34', '2024-06-15 00:00:20', 1.00, 34.10, 5, 44.65, 34.10, 0.00, 0, 0.00, 0, 0, 2),
(178, 1, '1850108166', '2024-06-15 10:06:43', '2024-06-15 18:17:40', 10.50, 28.95, 2, 28.95, 10.49, 18.46, 0, 0.00, 0, 0, 2),
(179, 1, '1850108166', '2024-06-15 18:18:23', '2024-06-16 00:02:00', 10.65, 23.72, 2, 23.72, 23.72, 0.00, 0, 0.00, 0, 0, 2),
(180, 1, '1850108166', '2024-06-16 07:07:36', '2024-06-16 23:23:44', 7.50, 76.78, 10, 76.78, 57.33, 0.00, 0, 19.45, 0, 0, 2),
(181, 1, '1850108166', '2024-06-19 18:02:37', '2024-06-22 07:03:23', 6.00, 5.99, 1, 5.99, 5.99, 0.00, 0, 0.00, 0, 0, 2),
(182, 1, '1850108166', '2024-06-22 07:03:59', '2024-06-22 23:59:50', 5.60, 32.68, 6, 32.68, 26.69, 5.99, 0, 0.00, 0, 0, 2),
(183, 1, '302433214', '2024-06-23 19:29:12', '2024-06-24 00:02:30', 1.00, 74.37, 7, 74.37, 63.40, 10.97, 0, 0.00, 0, 0, 2),
(184, 1, '1850108166', '2024-06-28 08:18:39', '2024-06-29 00:03:34', 5.35, 22.46, 2, 22.46, 22.46, 0.00, 0, 0.00, 0, 0, 2),
(185, 1, '1850108166', '2024-06-29 07:00:12', '2024-06-30 00:02:10', 2.30, 58.64, 6, 58.64, 58.64, 0.00, 0, 0.00, 0, 0, 2),
(186, 1, '1850108166', '2024-06-30 07:02:16', '2024-06-30 23:20:59', 2.50, 35.22, 3, 35.22, 35.22, 0.00, 0, 0.00, 0, 0, 2),
(187, 1, '1850108166', '2024-07-05 08:04:59', '2024-07-06 00:08:11', 2.75, 47.67, 5, 47.67, 41.68, 5.99, 0, 0.00, 0, 0, 2),
(188, 1, '1850108166', '2024-07-06 07:06:44', '2024-07-06 23:58:59', 3.00, 26.21, 5, 26.21, 26.21, 0.00, 0, 0.00, 0, 0, 2),
(189, 1, '1850108166', '2024-07-07 06:59:49', '2024-07-07 23:12:22', 10.00, 16.50, 2, 16.50, 16.50, 0.00, 0, 0.00, 0, 0, 2),
(190, 1, '1850108166', '2024-07-12 08:02:09', '2024-07-12 23:56:48', 6.50, 49.41, 7, 49.41, 49.41, 0.00, 0, 0.00, 0, 0, 2),
(191, 1, '1850108166', '2024-07-13 07:00:42', '2024-07-13 23:31:32', 3.50, 72.67, 7, 72.67, 66.44, 6.23, 0, 0.00, 0, 0, 2),
(192, 1, '1850108166', '2024-07-14 09:58:37', '2024-07-14 22:27:59', 6.40, 51.62, 4, 51.62, 26.92, 0.00, 0, 24.70, 0, 0, 2),
(193, 1, '1850108166', '2024-07-19 08:02:20', '2024-07-20 00:04:45', 16.35, 25.18, 5, 25.18, 25.18, 0.00, 0, 0.00, 0, 0, 2),
(194, 1, '1850108166', '2024-07-20 07:22:02', '2024-07-21 22:52:18', 10.00, 73.37, 4, 73.37, 48.41, 24.96, 0, 0.00, 0, 0, 2),
(195, 1, '1850108166', '2024-07-25 18:33:30', '2024-08-23 23:48:54', 9.80, 1.00, 1, 23.96, 1.00, 0.00, 0, 0.00, 0, 0, 2),
(196, 1, '1756269757', '2024-08-23 23:50:58', '2024-08-23 23:57:45', 10.00, 21.98, 2, 11.98, 11.98, 10.00, 0, 0.00, 0, 0, 2),
(197, 1, '1756269757', '2024-08-23 23:59:31', '2024-08-24 00:03:10', 12.00, 21.97, 1, 9.97, 19.00, 2.97, 0, 0.00, 0, 0, 2),
(198, 1, '1756269757', '2024-08-24 07:37:50', '2024-08-25 00:39:04', 15.75, 256.19, 12, 240.44, 256.19, 0.00, 0, 0.00, 0, 0, 2),
(199, 1, '1756269757', '2024-08-25 08:35:05', '2024-08-25 23:08:21', 45.00, 221.62, 6, 221.62, 221.62, 0.00, 0, 0.00, 0, 0, 2),
(200, 1, '1850108166', '2024-08-29 20:07:55', '2024-08-29 23:55:34', 4.10, 25.94, 2, 25.94, 7.97, 17.97, 0, 0.00, 0, 0, 2),
(201, 1, '1756269757', '2024-08-30 08:00:01', '2024-08-31 00:00:01', 2.30, 119.24, 13, 119.24, 112.27, 6.97, 0, 0.00, 0, 0, 2),
(202, 1, '1756269757', '2024-08-31 07:20:15', '2024-08-31 10:52:49', 7.80, 167.73, 19, 167.72, 157.73, 10.00, 0, 0.00, 0, 0, 2),
(203, 1, '1756269757', '2024-08-31 18:02:41', '2024-09-01 00:12:41', 15.00, 134.00, 12, 134.00, 98.83, 35.17, 0, 0.00, 0, 0, 2),
(204, 1, '1234', '2024-09-01 00:16:21', '2024-09-01 00:55:59', 10.00, 24.98, 1, 14.98, 24.98, 0.00, 0, 0.00, 0, 0, 2),
(205, 1, '1234', '2024-09-01 00:56:40', '2024-09-01 01:17:06', 1.00, 666.00, 9, 95.84, 666.00, 0.00, 0, 0.00, 0, 0, 2),
(206, 1, '1234', '2024-09-01 09:52:42', '2024-09-01 11:14:18', 1.00, 143.65, 5, 140.92, 135.65, 8.00, 0, 0.00, 0, 0, 2),
(207, 1, '1756269757', '2024-09-01 18:23:03', '2024-09-01 23:14:55', 17.80, 23.50, 5, 23.48, 23.50, 0.00, 0, 0.00, 0, 0, 2),
(208, 1, '1850108166', '2024-09-05 08:15:06', '2024-09-05 23:08:22', 33.75, 13.47, 3, 13.47, 5.98, 7.49, 0, 0.00, 0, 0, 2),
(209, 1, '1850108166', '2024-09-06 08:04:33', '2024-09-07 00:04:51', 33.75, 100.74, 14, 100.74, 91.77, 8.97, 0, 0.00, 0, 0, 2),
(210, 1, '1756269757', '2024-09-07 08:01:02', '2024-09-07 18:11:37', 16.75, 69.38, 6, 69.38, 34.96, 34.42, 0, 0.00, 0, 0, 2),
(211, 1, '1756269757', '2024-09-07 18:15:31', '2024-09-07 23:57:46', 11.50, 116.59, 9, 116.59, 63.17, 53.42, 0, 0.00, 0, 0, 2),
(212, 1, '1756269757', '2024-09-08 07:48:51', '2024-09-08 11:47:31', 11.75, 124.08, 7, 119.80, 81.97, 42.11, 0, 0.00, 12, 0, 2),
(213, 1, '1756269757', '2024-09-12 18:17:45', '2024-09-12 23:56:00', 25.00, 100.00, 10, 100.00, 81.05, 12.97, 6, 0.00, 0, 0, 2),
(214, 1, '1756269757', '2024-09-13 09:12:07', '2024-09-14 00:05:51', 15.00, 160.00, 11, 160.00, 160.00, 0.00, 0, 0.00, 4, 0, 2),
(215, 1, '1756269757', '2024-09-14 08:19:51', '2024-09-14 11:33:13', 32.00, 172.50, 9, 142.92, 126.00, 46.50, 0, 0.00, 3, 0, 2),
(216, 1, '1756269757', '2024-09-14 11:34:21', '2024-09-15 00:04:22', 26.20, 91.65, 9, 80.57, 65.20, 26.45, 0, 0.00, 15, 0, 2),
(217, 1, '1850108166', '2024-12-31 11:31:46', '2025-01-02 16:14:20', 1.00, 570.00, 16, 285.55, 12.00, 312.00, 123, 123.00, 13, 0, 2),
(218, 1, '1850108166', '2025-01-02 18:12:01', '2025-01-03 08:06:51', 18.00, 367.91, 20, 367.91, 295.00, 61.91, 0, 11.00, 0, 0, 2),
(219, 1, '1850108166', '2025-01-03 08:07:36', '2025-01-03 08:08:57', 1.00, 0.00, 2, 23.94, 0.00, 0.00, 0, 0.00, 0, 0, 2),
(220, 1, '1756269757', '2025-01-03 09:51:05', '2025-01-03 18:35:27', 1.00, 183.76, 13, 183.76, 148.83, 26.97, 0, 7.96, 6, 0, 2),
(221, 1, '1756269757', '2025-01-03 18:36:22', '2025-01-04 00:22:31', 13.35, 166.37, 19, 326.72, 166.37, 0.00, 0, 0.00, 15, 0, 2),
(222, 1, '1756269757', '2025-01-04 08:09:51', '2025-01-05 00:28:17', 1.30, 195.03, 18, 195.03, 68.80, 106.28, 20, 0.00, 0, 0, 2),
(223, 1, '1756269757', '2025-01-05 08:38:39', '2025-01-05 11:33:38', 10.95, 108.94, 11, 108.84, 29.98, 78.96, 0, 0.00, 3, 0, 2),
(224, 1, '1756269757', '2025-01-05 18:23:25', '2025-01-05 22:48:38', 0.55, 12.51, 1, 11.96, 0.55, 0.00, 0, 11.96, 0, 0, 2),
(225, 1, '1850108166', '2025-01-10 20:29:37', '2025-01-11 00:01:37', 20.00, 9.48, 2, 9.48, 9.48, 0.00, 0, 0.00, 0, 0, 2),
(226, 1, '1850108166', '2025-01-11 18:14:15', '2025-01-12 00:00:30', 15.50, 20.96, 1, 20.96, 0.00, 20.96, 0, 0.00, 0, 0, 2),
(227, 1, '302433214', '2025-01-12 11:18:30', '2025-01-13 00:14:14', 1.00, 56.44, 3, 56.44, 56.44, 0.00, 0, 0.00, 9, 0, 2),
(228, 1, '1850108166', '2025-01-18 19:13:28', '2025-01-19 00:32:34', 52.20, 111.73, 4, 111.73, 79.32, 0.00, 32, 0.00, 0, 0, 2),
(229, 1, '1850108166', '2025-01-19 08:01:47', '2025-01-19 23:06:58', 1.70, 29.43, 5, 29.43, 11.47, 0.00, 18, 0.00, 0, 0, 2),
(230, 1, '1756269757', '2025-01-20 14:11:55', '2025-01-25 02:40:18', 1.00, 4666.00, 2, 82.33, 4666.00, 0.00, 0, 0.00, 6, 0, 2),
(231, 1, '1756269757', '2025-01-25 02:40:33', '2025-01-25 02:47:20', 1.00, 444.00, 0, 0.00, 444.00, 0.00, 0, 0.00, 0, 0, 2),
(232, 1, '1756269757', '2025-01-25 02:47:34', '2025-01-25 02:47:55', 4.00, 0.00, 0, 0.00, 0.00, 0.00, 0, 0.00, 0, 0, 2),
(233, 1, '1756269757', '2025-01-25 02:48:07', '2025-01-25 02:48:47', 3.00, 0.00, 0, 0.00, 0.00, 0.00, 0, 0.00, 0, 0, 2),
(234, 1, '1756269757', '2025-01-25 02:49:07', '2025-01-25 03:34:10', 1.00, 3.50, 5, 7.50, 3.50, 0.00, 0, 0.00, -5, 0, 2),
(235, 1, '1756269757', '2025-01-25 03:35:59', '2025-01-25 12:21:15', 1.00, 32.00, 0, -1.00, 32.00, 0.00, 0, 0.00, 0, 6, 2),
(236, 1, '1756269757', '2025-01-25 12:29:28', '2025-02-04 23:54:26', 1.00, 100.00, 3, 38.87, 100.00, 0.00, 0, 0.00, 0, 20, 2),
(237, 1, '1234', '2025-02-04 23:54:42', '2025-06-14 23:51:27', 1.00, 20.00, 1, 9.98, 20.00, 0.00, 0, 0.00, 0, 10, 2),
(238, 2, '1234', '2025-06-21 22:48:20', '2025-06-21 22:51:10', 10.00, 50.00, 3, 43.94, 50.00, 0.00, 0, 0.00, 0, 13, 2),
(239, 1, '1234', '2025-06-21 22:51:30', '2025-06-22 13:01:37', 10.00, 60.00, 2, 36.95, 10.00, 0.00, 40, 10.00, 0, 60, 2),
(240, 1, '1234', '2025-06-22 13:02:33', '2025-06-22 16:31:02', 10.00, 20.00, 0, 10.00, 10.00, 0.00, 0, 10.00, 0, 20, 2),
(241, 1, '1234', '2025-06-22 16:41:26', '2025-06-22 16:41:50', 12.00, 10.00, 0, 12.00, 10.00, 0.00, 0, 0.00, 0, 10, 2),
(242, 1, '1234', '2025-06-22 16:45:47', '2025-06-22 16:46:19', 1.00, 10.00, 0, 1.00, 10.00, 0.00, 0, 0.00, 0, 1, 2),
(243, 1, '1234', '2025-06-22 16:48:34', '2025-06-22 16:49:00', 1.00, 10.00, 0, 1.00, 0.00, 0.00, 0, 10.00, 0, 30, 2),
(244, 1, '1234', '2025-06-22 16:50:33', '2025-06-22 16:51:21', 3.00, 10.00, 0, 3.00, 10.00, 0.00, 0, 0.00, 0, 100, 2),
(245, 1, '1234', '2025-06-22 16:52:00', NULL, 30.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1);
...
--
-- Estructura de tabla para la tabla `auditoria_cierre_caja`
--

DROP TABLE IF EXISTS `auditoria_cierre_caja`;
CREATE TABLE IF NOT EXISTS `auditoria_cierre_caja` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `auditoria_cierre_caja`
--

INSERT INTO `auditoria_cierre_caja` (`id`, `id_cierre`, `tipo_pago`, `estado`, `diferencia`, `fecha_registro`) VALUES
(1, 237, 'Efectivo', 'SOBRANTE', 10.02, '2025-06-14 23:51:27'),
(2, 237, 'Tarjeta', 'OK', 0.00, '2025-06-14 23:51:27'),
(3, 237, 'Transferencia', 'OK', 0.00, '2025-06-14 23:51:27'),
(4, 237, 'Deuna', 'OK', 0.00, '2025-06-14 23:51:27'),
(5, 238, 'Efectivo', 'SOBRANTE', 6.06, '2025-06-21 22:51:10'),
(6, 238, 'Tarjeta', 'OK', 0.00, '2025-06-21 22:51:10'),
(7, 238, 'Transferencia', 'OK', 0.00, '2025-06-21 22:51:10'),
(8, 238, 'Deuna', 'OK', 0.00, '2025-06-21 22:51:10'),
(9, 239, 'Efectivo', 'FALTANTE', 26.95, '2025-06-22 13:01:37'),
(10, 239, 'Tarjeta', 'SOBRANTE', 10.00, '2025-06-22 13:01:37'),
(11, 239, 'Transferencia', 'OK', 0.00, '2025-06-22 13:01:37'),
(12, 239, 'Deuna', 'SOBRANTE', 40.00, '2025-06-22 13:01:37'),
(13, 240, 'Efectivo', 'OK', 0.00, '2025-06-22 16:31:02'),
(14, 240, 'Tarjeta', 'SOBRANTE', 10.00, '2025-06-22 16:31:02'),
(15, 240, 'Transferencia', 'OK', 0.00, '2025-06-22 16:31:02'),
(16, 240, 'Deuna', 'OK', 0.00, '2025-06-22 16:31:02'),
(17, 241, 'Efectivo', 'FALTANTE', 2.00, '2025-06-22 16:41:50'),
(18, 241, 'Tarjeta', 'OK', 0.00, '2025-06-22 16:41:50'),
(19, 241, 'Transferencia', 'OK', 0.00, '2025-06-22 16:41:50'),
(20, 241, 'Deuna', 'OK', 0.00, '2025-06-22 16:41:50'),
(21, 242, 'Efectivo', 'SOBRANTE', 9.00, '2025-06-22 16:46:19'),
(22, 242, 'Tarjeta', 'OK', 0.00, '2025-06-22 16:46:19'),
(23, 242, 'Transferencia', 'OK', 0.00, '2025-06-22 16:46:19'),
(24, 242, 'Deuna', 'OK', 0.00, '2025-06-22 16:46:19'),
(25, 243, 'Efectivo', 'FALTANTE', 1.00, '2025-06-22 16:49:00'),
(26, 243, 'Tarjeta', 'SOBRANTE', 10.00, '2025-06-22 16:49:00'),
(27, 243, 'Transferencia', 'OK', 0.00, '2025-06-22 16:49:00'),
(28, 243, 'Deuna', 'OK', 0.00, '2025-06-22 16:49:00'),
(29, 244, 'Efectivo', 'SOBRANTE', 7.00, '2025-06-22 16:51:21'),
(30, 244, 'Tarjeta', 'OK', 0.00, '2025-06-22 16:51:21'),
(31, 244, 'Transferencia', 'OK', 0.00, '2025-06-22 16:51:21'),
(32, 244, 'Deuna', 'OK', 0.00, '2025-06-22 16:51:21');
...
--
-- Estructura de tabla para la tabla `cola_envios`
--
...
--
-- Estructura de tabla para la tabla `correos_marketing`
--

DROP TABLE IF EXISTS `correos_marketing`;
...
--
-- Volcado de datos para la tabla `correos_marketing`
--

INSERT INTO `correos_marketing` (`id`, `correo`, `fecha_registro`) VALUES
(7, 'fafs.1405@gmail.com', '2025-06-28 18:33:17'),
(8, 'francis_andre94@hotmail.com', '2025-06-28 18:35:04');
...
(5426, 1509, 5, 1, 5.99, 0, NULL, 1, NULL),
(5427, 1509, 4, 1, 4.99, 0, NULL, 1, NULL),
(5428, 1509, 2, 1, 4.99, 0, NULL, 1, NULL),
(5429, 1509, 6, 1, 3.99, 0, NULL, 1, NULL),
(5430, 1509, 7, 1, 3.50, 0, NULL, 1, NULL),
(5431, 1509, 13, 1, 0.99, 0, NULL, 1, NULL),
(5432, 1509, 13, 1, 0.99, 0, NULL, 1, NULL),
(5433, 1509, 13, 1, 0.99, 0, NULL, 1, NULL),
(5434, 1509, 5, 1, 5.99, 0, NULL, 1, NULL),
(5435, 1509, 6, 1, 3.99, 0, NULL, 1, NULL),
(5436, 1509, 7, 1, 3.50, 0, NULL, 1, NULL),
(5437, 1509, 12, 1, 1.99, 0, NULL, 1, NULL),
(5438, 1509, 4, 5, 4.99, 0, NULL, 1, NULL),
(5439, 1509, 5, 1, 5.99, 0, NULL, 1, NULL),
(5440, 1509, 3, 1, 5.50, 0, NULL, 1, NULL),
(5441, 1510, 6, 1, 3.99, 0, NULL, 1, NULL),
(5442, 1511, 69, 1, 1.50, 0, NULL, 1, NULL),
(5443, 1512, 69, 1, 1.50, 0, NULL, 1, NULL),
(5444, 1513, 69, 1, 1.50, 0, NULL, 1, NULL),
(5445, 1514, 69, 1, 1.50, 0, NULL, 1, NULL),
(5446, 1515, 69, 1, 1.50, 0, NULL, 1, NULL),
(5447, 1516, 4, 1, 4.99, 0, NULL, 1, NULL),
(5448, 1516, 9, 1, 0.99, 0, NULL, 1, NULL),
(5449, 1516, 11, 1, 0.99, 0, NULL, 1, NULL),
(5450, 1516, 10, 1, 0.99, 0, NULL, 1, NULL),
(5451, 1516, 10, 1, 0.99, 0, NULL, 1, NULL),
(5454, 1517, 5, 1, 5.99, 0, NULL, 1, NULL),
(5455, 1517, 12, 1, 1.99, 0, NULL, 1, NULL),
(5456, 1517, 12, 1, 1.99, 0, NULL, 1, NULL),
(5457, 1517, 11, 1, 0.99, 0, NULL, 1, NULL),
(5458, 1517, 11, 1, 0.99, 0, NULL, 1, NULL),
(5461, 1518, 5, 1, 5.99, 0, NULL, 1, NULL),
(5462, 1518, 5, 1, 5.99, 0, NULL, 1, NULL),
(5463, 1518, 4, 1, 4.99, 0, NULL, 1, NULL),
(5464, 1519, 1, 1, 3.99, 0, NULL, 1, '{\"1\":\"Cafe Pasado\",\"2\":\"Jugo Papaya\",\"3\":\"Frito Suave\", \"ob\": \"\"}'),
(5465, 1519, 2, 1, 4.99, 0, NULL, 1, '{\"1\":\"Agua\",\"2\":\"Jugo Papaya\",\"3\":\"Frito Duro\", \"ob\": \"\"}'),
(5466, 1520, 5, 1, 5.99, 0, NULL, 1, NULL),
(5467, 1520, 5, 1, 5.99, 0, NULL, 1, NULL),
(5469, 1521, 5, 1, 5.99, 0, NULL, 1, NULL),
(5470, 1521, 5, 1, 5.99, 0, NULL, 1, NULL),
(5472, 1522, 4, 1, 4.99, 0, NULL, 1, NULL),
(5473, 1522, 4, 1, 4.99, 0, NULL, 1, NULL),
(5475, 1523, 5, 1, 5.99, 0, NULL, 1, NULL),
(5476, 1523, 5, 1, 5.99, 0, NULL, 1, NULL),
(5477, 1523, 5, 1, 5.99, 0, NULL, 1, NULL),
(5478, 1524, 4, 1, 4.99, 0, NULL, 1, NULL),
(5479, 1524, 4, 1, 4.99, 0, NULL, 1, NULL),
(5480, 1525, 6, 1, 3.99, 0, NULL, 1, NULL),
(5481, 1526, 6, 1, 3.99, 0, NULL, 1, NULL),
(5482, 1526, 6, 1, 3.99, 0, NULL, 1, NULL),
(5484, 1527, 5, 1, 5.99, 0, NULL, 1, NULL),
(5485, 1527, 5, 1, 5.99, 0, NULL, 1, NULL),
(5487, 1528, 6, 1, 3.99, 0, NULL, 1, NULL),
(5488, 1528, 5, 1, 5.99, 0, NULL, 1, NULL),
(5490, 1529, 5, 1, 5.99, 0, NULL, 1, NULL),
(5491, 1529, 5, 1, 5.99, 0, NULL, 1, NULL),
(5493, 1530, 5, 1, 5.99, 0, NULL, 1, NULL),
(5494, 1530, 5, 1, 5.99, 0, NULL, 1, NULL),
(5495, 1530, 5, 1, 5.99, 0, NULL, 1, NULL),
(5496, 1531, 4, 1, 4.99, 0, NULL, 1, NULL),
(5497, 1531, 4, 1, 4.99, 0, NULL, 1, NULL),
(5499, 1532, 5, 1, 5.99, 0, NULL, 1, NULL),
(5500, 1532, 5, 1, 5.99, 0, NULL, 1, NULL),
(5501, 1532, 5, 1, 5.99, 0, NULL, 1, NULL),
(5502, 1533, 6, 1, 3.99, 0, NULL, 1, NULL),
(5503, 1533, 6, 1, 3.99, 0, NULL, 1, NULL),
(5505, 1534, 6, 1, 3.99, 0, NULL, 1, NULL),
(5506, 1534, 6, 1, 3.99, 0, NULL, 1, NULL),
(5508, 1535, 4, 1, 4.99, 0, NULL, 1, NULL),
(5509, 1535, 4, 1, 4.99, 0, NULL, 1, NULL),
(5511, 1536, 6, 1, 3.99, 0, NULL, 1, NULL),
(5512, 1536, 6, 1, 3.99, 0, NULL, 1, NULL),
(5514, 1537, 5, 1, 5.99, 0, NULL, 1, NULL),
(5515, 1537, 5, 1, 5.99, 0, NULL, 1, NULL),
(5517, 1538, 6, 1, 3.99, 0, NULL, 1, NULL),
(5518, 1538, 6, 1, 3.99, 0, NULL, 1, NULL),
(5520, 1539, 6, 1, 3.99, 0, NULL, 1, NULL),
(5521, 1539, 6, 1, 3.99, 0, NULL, 1, NULL),
(5523, 1540, 5, 1, 5.99, 0, NULL, 1, NULL),
(5524, 1540, 5, 1, 5.99, 0, NULL, 1, NULL),
(5526, 1541, 7, 1, 3.50, 0, NULL, 1, NULL),
(5527, 1541, 7, 1, 3.50, 0, NULL, 1, NULL),
(5528, 1541, 7, 1, 3.50, 0, NULL, 1, NULL),
(5529, 1542, 5, 1, 5.99, 0, NULL, 1, NULL),
(5530, 1542, 5, 1, 5.99, 0, NULL, 1, NULL),
(5532, 1543, 5, 1, 5.99, 0, NULL, 1, NULL),
(5533, 1543, 5, 1, 5.99, 0, NULL, 1, NULL),
(5535, 1544, 6, 1, 3.99, 0, NULL, 1, NULL),
(5536, 1544, 6, 1, 3.99, 0, NULL, 1, NULL),
(5538, 1545, 6, 1, 3.99, 0, NULL, 1, NULL),
(5539, 1545, 6, 1, 3.99, 0, NULL, 1, NULL),
(5541, 1546, 6, 1, 3.99, 0, NULL, 1, NULL),
(5542, 1546, 6, 1, 3.99, 0, NULL, 1, NULL),
(5544, 1547, 4, 1, 4.99, 0, NULL, 1, NULL),
(5545, 1547, 3, 1, 5.50, 0, NULL, 1, NULL),
(5547, 1548, 5, 1, 5.99, 0, NULL, 1, NULL),
(5548, 1548, 4, 1, 4.99, 0, NULL, 1, NULL),
(5549, 1548, 4, 1, 4.99, 0, NULL, 1, NULL),
(5550, 1549, 4, 1, 4.99, 0, NULL, 1, NULL),
(5551, 1549, 4, 1, 4.99, 0, NULL, 1, NULL),
(5553, 1550, 5, 1, 5.99, 0, NULL, 1, NULL),
(5554, 1550, 4, 1, 4.99, 0, NULL, 1, NULL),
(5555, 1550, 4, 1, 4.99, 0, NULL, 1, NULL),
(5556, 1550, 4, 1, 4.99, 0, NULL, 1, NULL),
(5560, 1551, 4, 1, 4.99, 0, NULL, 1, NULL),
(5561, 1551, 4, 1, 4.99, 0, NULL, 1, NULL),
(5562, 1551, 4, 1, 4.99, 0, NULL, 1, NULL),
(5563, 1552, 9, 1, 0.99, 0, NULL, 1, NULL),
(5564, 1552, 8, 1, 2.99, 0, NULL, 1, NULL),
(5565, 1552, 8, 1, 2.99, 0, NULL, 1, NULL),
(5566, 1553, 9, 1, 0.99, 0, NULL, 1, NULL),
(5567, 1553, 7, 1, 3.50, 0, NULL, 1, NULL),
(5569, 1554, 4, 1, 4.99, 0, NULL, 1, NULL),
(5570, 1554, 7, 1, 3.50, 0, NULL, 1, NULL),
(5571, 1554, 7, 1, 3.50, 0, NULL, 1, NULL);
...
CREATE TABLE IF NOT EXISTS `detalle_temp` (
  ...
  `observaciones` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`correlativo`)
) ENGINE=InnoDB AUTO_INCREMENT=7601 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1509, '2025-01-24 19:14:31', 1756269757, 1, 1, 78.34, 1, '1', 'NODESCUENT', 1, 230, 4),
(1510, '2025-01-24 19:15:55', 1756269757, 1, 1, 3.99, 1, '1', 'NODESCUENT', 1, 230, 4),
(1511, '2025-01-25 02:50:16', 1756269757, 1, 1, 1.50, 1, '1', 'NODESCUENT', 1, 234, 4),
(1512, '2025-01-25 02:50:39', 1756269757, 1, 1, 1.50, 1, '1', 'NODESCUENT', 1, 234, 4),
(1513, '2025-01-25 02:51:04', 1756269757, 1, 1, 1.50, 3, '', 'NODESCUENT', 1, 234, 4),
(1514, '2025-01-25 02:51:22', 1756269757, 1, 1, 1.50, 4, '', 'NODESCUENT', 1, 234, 4),
(1515, '2025-01-25 02:52:01', 1756269757, 1, 1, 1.50, 2, '', 'NODESCUENT', 1, 234, 4),
(1516, '2025-01-26 15:51:41', 1756269757, 1, 1, 8.95, 1, '1', 'NODESCUENT', 1, 236, 4),
(1517, '2025-01-26 15:52:00', 1756269757, 1, 1, 11.95, 2, '', 'NODESCUENT', 1, 236, 4),
(1518, '2025-01-26 15:52:21', 1756269757, 1, 2, 16.97, 3, '', 'NODESCUENT', 1, 236, 4),
(1519, '2025-04-03 20:54:21', 1234, 1, 1, 8.98, 1, '1', 'NODESCUENT', 1, 237, 4),
(1520, '2025-06-21 22:49:50', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 2, 238, 4),
(1521, '2025-06-21 22:50:03', 1234, 1, 4, 11.98, 1, '1', 'NODESCUENT', 2, 238, 4),
(1522, '2025-06-21 22:50:14', 1234, 1, 1, 9.98, 1, '1', 'NODESCUENT', 2, 238, 4),
(1523, '2025-06-21 22:52:05', 1234, 1, 1, 17.97, 1, '1', 'NODESCUENT', 1, 239, 4),
(1524, '2025-06-22 00:19:49', 1234, 1, 1, 9.98, 1, '1', 'NODESCUENT', 1, 239, 4),
(1525, '2025-06-28 13:58:44', 1234, 1, 1, 3.99, 2, '', 'NODESCUENT', 1, NULL, 1),
(1526, '2025-06-28 14:03:20', 1234, 1, 2, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1527, '2025-06-28 14:44:24', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1528, '2025-06-28 15:50:09', 1234, 1, 1, 9.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1529, '2025-06-28 15:52:49', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1530, '2025-06-28 15:53:15', 1234, 1, 2, 17.97, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1531, '2025-06-28 15:53:27', 1234, 1, 4, 9.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1532, '2025-06-28 16:07:38', 1234, 1, 1, 17.97, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1533, '2025-06-28 16:11:50', 1234, 1, 1, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1534, '2025-06-28 16:12:17', 1234, 1, 1, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1535, '2025-06-28 16:15:23', 1234, 1, 1, 9.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1536, '2025-06-28 16:17:40', 1234, 1, 1, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1537, '2025-06-28 16:22:50', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1538, '2025-06-28 16:23:23', 1234, 1, 2, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1539, '2025-06-28 16:24:37', 1234, 1, 2, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1540, '2025-06-28 16:25:24', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1541, '2025-06-28 17:43:31', 1234, 1, 1, 10.50, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1542, '2025-06-28 17:46:34', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1543, '2025-06-28 17:59:08', 1234, 1, 1, 11.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1544, '2025-06-28 18:02:50', 1234, 1, 6, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1545, '2025-06-28 18:03:59', 1234, 1, 10, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1546, '2025-06-28 18:04:42', 1234, 1, 3, 7.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1547, '2025-06-28 18:15:01', 1234, 1, 4, 10.49, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1548, '2025-06-28 18:26:30', 1234, 1, 7, 15.97, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1549, '2025-06-28 18:27:40', 1234, 1, 2, 9.98, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1550, '2025-06-28 18:32:34', 1234, 1, 7, 20.96, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1551, '2025-06-28 18:33:17', 1234, 1, 3, 14.97, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1552, '2025-06-28 18:35:04', 1234, 1, 15, 6.97, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1553, '2025-06-28 18:38:43', 1234, 1, 11, 4.49, 1, '1', 'NODESCUENT', 1, NULL, 1),
(1554, '2025-06-28 18:39:02', 1234, 1, 2, 11.99, 1, '1', 'NODESCUENT', 1, NULL, 1);
...
(28, '2025-01-25 01:56:00', 1, 423.00, 1, 1, '1', '1756269757', 'sfsdf', 1),
(29, '2025-01-25 01:58:00', 1, 234.00, 1, 1, '1', '1756269757', 'adsdasd', 1),
(30, '2025-01-25 02:00:57', 1, 7500.00, 1, 2, '1', '1756269757', 'sfsdf', 1),
(31, '2025-01-25 02:55:47', 1, 1.00, 1, 2, '1', '1756269757', 'efectivo', 1),
(32, '2025-01-25 02:56:32', 1, 1.00, 2, 1, '1', '1756269757', '1', 1),
(33, '2025-01-25 03:23:01', 1, 5.00, 1, 1, '1', '1756269757', 'efectivo', 1),
(34, '2025-01-25 11:19:27', 1, 2.00, 1, 1, '6', '1756269757', 'malcriadez', 1),
(35, '2025-01-26 15:51:10', 1, 15.00, 1, 2, '1', '1756269757', 'Suletos', 1),
(36, '2025-01-26 15:51:24', 1, 5.00, 1, 1, '2', '1756269757', 'Carne', 1),
(37, '2025-06-21 23:08:01', 1, 10.00, 1, 1, '2', '1234', 'aa', 1),
(38, '2025-06-22 00:22:31', 1, 10.00, 1, 2, '1', '1234', 'VUELTO', 1),
(39, '2025-06-22 00:25:52', 1, 1.00, 1, 1, '1', '1234', '1', 1);
...
INSERT INTO `mesas` (`id`, `numero`, `nombre`, `estatus`) VALUES
(1, '1', 'Cliente', 1),
(2, '2', 'Cliente', 1),
(3, '3', 'Cliente', 1),
(4, '4', 'Cliente', 1),
...
(0, 1, '0', 'DESAYUNO CONTINENTAL', 0, 3.99, 0, 0, -138, 23, 1, 'logo.jpg', '1,2,3', 1),
(0, 2, '0', 'DESAYUNO AMERICANO ', 0, 4.99, 0, 0, -57, 23, 1, 'logo.jpg', '3,1,2', 1),
(0, 3, '0', 'DESAYUNO MONTUBIO', 0, 5.50, 0, 0, -136, 23, 1, 'logo.jpg', '25,1,2,3', 1),
(0, 4, '0', 'DESAYUNO CALIKAPE', 0, 4.99, 0, 0, -87, 23, 1, 'logo.jpg', '1,2', 1),
(0, 5, '0', 'DESAYUNO CALIKAPE XL', 0, 5.99, 0, 0, -109, 23, 1, 'logo.jpg', '1,2', 1),
(0, 6, '0', 'WAFFLES CON FRUTAS', 0, 3.99, 0, 0, -43, 24, 1, 'logo.jpg', '', 1),
(0, 7, '0', 'PANCAKES CLASICO', 0, 3.50, 0, 0, -15, 24, 1, 'logo.jpg', '', 1),
(0, 8, '0', 'ENSALADA DE FRUTAS', 0, 2.99, 0, 0, -13, 24, 1, 'logo.jpg', '', 1),
(0, 9, '0', 'CANASTA DE PAN', 0, 0.99, 0, 0, -25, 24, 1, 'logo.jpg', '', 1),
(0, 10, '0', 'TOCINO', 0, 0.99, 0, 0, -14, 24, 1, 'logo.jpg', '', 1),
(0, 11, '0', 'SALSA DE QUESO', 0, 0.99, 0, 0, -9, 24, 1, 'logo.jpg', '', 1),
(0, 12, '0', 'BISTEC DE CARNE', 0, 1.99, 0, 0, -13, 24, 1, 'logo.jpg', '', 1),
(0, 13, '0', 'PICO DE GALLO', 0, 0.99, 0, 0, -4, 24, 1, 'logo.jpg', '', 1),
...
(0, 69, '0', 'LIMONADA', 0, 1.50, 0, 0, -52, 20, 1, 'logo.jpg', '2,9', 1),
...
--
-- Estructura de tabla para la tabla `promociones_redimidas`
--

DROP TABLE IF EXISTS `promociones_redimidas`;
CREATE TABLE IF NOT EXISTS `promociones_redimidas` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `fecha` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `correo` (`correo`(191))
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Volcado de datos para la tabla `promociones_redimidas`
--

INSERT INTO `promociones_redimidas` (`id`, `correo`, `codigo`, `redimido`, `fecha`) VALUES
(7, 'fafs.1405@gmail.com', 'PROMO-F527CBAE', 0, '2025-06-28 18:33:17'),
(8, 'francis_andre94@hotmail.com', 'PROMO-C984CD89', 0, '2025-06-28 18:35:04');
...
(5, 1756269757, 'Bella', 'Ramos', 'ejemplo@hotmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, 2, 1),
