...
if (empty($_REQUEST['cl']) || empty($_REQUEST['f'])) {
    ...
    if ($result > 0) {
        ...
        // Detectar tipo de factura (hotel o restaurante)
        $query_productos = mysqli_query($conection, "
				SELECT 
					IFNULL(p.producto, dt.descripcion_servicio) AS producto, 
					dt.cantidad, 
					dt.precio_venta, 
...
?>
				...
				<td class="info_factura">
					<div class="round">
						...
						<p>Hora:
							<?php echo $factura['hora']; ?>
						</p>
						<p>Vendedor:
							<?php echo $factura['vendedor1']; ?>
							<?php echo $factura['vendedor2']; ?>
						</p>
					</div>
				</td>
			</tr>
						...
						<table class="datos_cliente">
							<tr>
								<td><label>Cedula:</label>
									<p><?php echo $factura['usuario']; ?>
									</p>
								</td>
								<td><label>Teléfono:</label>
									<p><?php echo $factura['telefono']; ?>
									</p>
								</td>
							</tr>
							<tr>
								<td><label>Nombre:</label>
									<p><?php echo $factura['nombre']; ?>
										<?php echo $factura['p_apellido']; ?>
									</p>
								</td>
								<td><label>Dirección:</label>
									<p><?php echo $factura['direccion']; ?>
									</p>
								</td>
							</tr>
						</table>
			...
			<tfoot id="detalle_totales">
				<tr>
					...
					<td class="textright"><span>$
							<?php echo $tl_sniva; ?></span></td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span>IVA
							(<?php echo $iva; ?> %)</span></td>
					<td class="textright">
						<span><?php echo $impuesto; ?></span>
					</td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span><b>TOTAL</b></span></td>
					<td class="textright"><span><b>$
								<?php echo $total; ?></b></span></td>
				</tr>
			</tfoot>
		</table>
		<div>
