...
<header>
	<div class="header">
		...
		<div class="optionsBar">
			...
			<span
				class="user"><?php echo $_SESSION['nombre']." ".$_SESSION['apellido']." - ".$_SESSION['rol_name']; ?></span>
			<img class="photouser" src="img/user.png" alt="Usuario">
			<a href="salir.php" class="optionsBarSalir"><img class="close" src="img/salir.png" alt="Salir del Sistema"
					title="Salir"></a>
		</div>
	</div>
	<?php include"nav.php";?>
...
?>
			...
			<div class="acciones">
				<button type="button" class="boton verde" onclick="procesarDivisionCuenta();">Crear Nueva
					Factura</button>
