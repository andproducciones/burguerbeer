...
<head>
	...
	<style>
		...
		.chart-container {
			...
			max-width: 48%;
			/* Limitar el ancho al 48% para dos columnas */
		}
		...
		canvas {
			...
			/* Borde opcional para separar gráficos */
			border-radius: 8px;
			/* Bordes redondeados */
			padding: 10px;
			/* Espacio interno para estética */
			background: #fff;
			/* Fondo blanco */
		}
	</style>
...
<body>
    ...
    foreach ($productos_mas_vendidos as $producto) { ?>
					...
					<div class="divContainer" style="margin-top: 40px;">
			...
			<div class="containerPerfil">
				<div class="containerDataUser">
					<div class="divDataUser">
						...
						<div>
							<label>Nombre:</label>
							<span>Francis<?= $_SESSION['nombre'];?>
								<?= $_SESSION['apellido'];?></span>
						</div>
						<div>
							<label>Correo:</label>
